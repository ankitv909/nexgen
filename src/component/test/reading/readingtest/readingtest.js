    ...
    class Readingtest extends Component {
        constructor(props) {
            ...
            switch (this.props.location.pathname) {
                case '/readingtest/test/reading':
                    this.state = {value: 0};
                    break;
                case '/readingtest/instruction/reading':
                    this.state = {value: 1};
                    break;
                default:
                    this.state = {value: 0};
                                ...
                                <Grid container direction="row" justify="center" alignItems="center" item xs={12} lg={12} md={12} sm={12} xl={12}>
                                    <Grid container direction="row" justify="flex-start" alignItems="center" item xs={6} lg={6} md={6} sm={6} xl={6}>
                                        <Grid container direction="row" justify="flex-start" alignItems="center"  item xs={12} lg={12} md={12} sm={12} xl={12}>
                                            ...
                                            >
                                                <Tab classes={{ root: classes.tabRoot, selected: classes.tabSelected }} label="Passage" component={Link} to="/readingtest/test/reading" />
                                                <Tab classes={{ root: classes.tabRoot, selected: classes.tabSelected }} label="Instructions" component={Link} to="/readingtest/instruction/reading" />
                                            </Tabs>
                                        </Grid>
                                    </Grid>
                            ...
                            <Grid container direction="row" justify="center" alignItems="center" item xs={8} lg={8} md={8} sm={8} xl={8}>
                                <Grid container direction="row" justify="center" alignItems="center" item xs={8} lg={12} md={12} sm={12} xl={12} className={classes.Margin1}>
                                    <Paper className={classes.paper2}>
                                        <Switch>
                                            <Route  path={`${this.props.match.path}/test/reading`} component={Reading} />
                                            <Route  path={`${this.props.match.path}/instruction/reading`} component={Instruction} />
                                            <Redirect to='/readingtest/test/reading' />
                                        </Switch>
                                        {/* <Grid container direction="row" justify="flex-start" alignItems="center"  item xs={12} lg={12} md={12} sm={12} xl={12}>
                                            <AppBar position="static" color="default" className={classes.appbar}>
                                                <Tabs
                                                    ...
                                                    classes={{ root: classes.tabsRoot, indicator: classes.tabsIndicator }}
                                                >
                                                    <Tab classes={{ root: classes.tabRoot, selected: classes.tabSelected }} label="SEC 1" component={Link} to="/readingtest/instruction" />
                                                    <Tab classes={{ root: classes.tabRoot, selected: classes.tabSelected }} label="SEC 2" component={Link} to="/readingtest/instruction" />
                                                </Tabs>
                                            </AppBar>
                                            <Switch>
                                                <Route  path={`${this.props.match.path}/instruction`} component={Instruction} />
                                                <Route path={`${this.props.match.path}/instruction`} component={Instruction} />
                                                <Redirect to='/readingtest/instruction' />
                                            </Switch>
                                        </Grid>*/}
                                    </Paper>
                                </Grid>
                            ...
                            <Grid container direction="row" justify="center" alignItems="center" item xs={3} lg={3} md={3} sm={3} xl={3} className={classes.Margin1}>
                                <Paper className={classes.paper3}>
                                    ...
                                    <Grid container direction="row" justify="flex-end" alignItems="center" >
                                        ...
                                        <Grid container direction="row" justify="flex-start" alignItems="center" item lg={5} xs={12} md={8} sm={9} xl={5}> <div className={classes.notans}/><Typography variant="caption" className={classes.marginleft}> Not Answered</Typography></Grid>
    ...
    export default withStyles(styles)(Readingtest);
