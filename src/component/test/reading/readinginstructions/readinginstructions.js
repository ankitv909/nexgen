...
import './readinginstructions.css';
...
class Readinginstructions extends Component {
  constructor(props) {
    super(props);
    document.title = 'Readinginstructions';
    this.state = {
      checkedB: false,
    };
  }
  ...
  render() {
    ...
    return (
      <div className="readinginstructions">
            ...
            <Grid container direction="row" justify="center" alignItems="center" item xs={8} lg={7} md={8} sm={8} xl={8}>
              <Paper className={classes.paper2}>
                ...
                <Grid container direction="row" justify="center" alignItems="center">
                  <Button size="large" component={Link} to="/reading" disabled={!this.state.checkedB} variant="contained" color="primary" className={classes.viewButton} >
                    Start Exam
                  </Button>
                </Grid>
              </Paper>
...
Readinginstructions.propTypes = {
  classes: PropTypes.object.isRequired,
};


export default withStyles(styles)(Readinginstructions);
