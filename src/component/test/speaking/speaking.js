...
import Partfirst from "../speaking/partfirst/partfirst";
import Partsecond from "../speaking/partsecond/partsecond";
import Partthird from "../speaking/partthird/partthird";
...
class Speaking extends Component {
    constructor(props) {
        ...
        switch (this.props.location.pathname) {
            case '/test/speaking/part1':
                this.state = {value: 0};
                break;
            case '/test/speaking/part2':
                this.state = {value: 1};
                break;
            case '/test/speaking/part3':
                this.state = {value: 2};
                break;
            default:
                this.state = {value: 0};
                                ...
                                <Paper className={classes.paper2}>
                                    <Grid container direction="row" justify="flex-start" alignItems="center"  item xs={12} lg={12} md={12} sm={12} xl={12} className={classes.margintop8}>
                                        <AppBar position="static" color="default" className={classes.appbar}>
                                            ...
                                            >
                                                <Tab classes={{ root: classes.tabRoot, selected: classes.tabSelected }} label="PART I" component={Link} to="/speakingtest/test/speaking/part1" />
                                                <Tab classes={{ root: classes.tabRoot, selected: classes.tabSelected }} label="PART II" component={Link} to="/speakingtest/test/speaking/part2" />
                                                <Tab classes={{ root: classes.tabRoot, selected: classes.tabSelected }} label="PART III" component={Link} to="/speakingtest/test/speaking/part3" />
                                            </Tabs>
                                        </AppBar>
                                        <Switch>
                                            <Route  path={`${this.props.match.path}/part1`} component={Partfirst} />
                                            <Route path={`${this.props.match.path}/part2`} component={Partsecond} />
                                            <Route path={`${this.props.match.path}/part3`} component={Partthird} />
                                            <Redirect to='/speakingtest/test/speaking/part1' />
                                        </Switch>
                                    </Grid>
                                </Paper>
                            </Grid>
