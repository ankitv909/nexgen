...
import  Sec1 from "../listening/sec1/sec1";
import Sec2 from "../listening/sec2/sec2";
import Sec3 from "../listening/sec3/sec3";
...
class Listening extends Component {
    constructor(props) {
        ...
        switch (this.props.location.pathname) {
            case '/test/listening/sec1':
                this.state = {value: 0};
                break;
            case '/test/listening/sec2':
                this.state = {value: 1};
                break;
            case '/test/listening/sec3':
                this.state = {value: 2};
                break;
            default:
                this.state = {value: 0};
                                ...
                                <Paper className={classes.paper2}>
                                    <Grid container direction="row" justify="flex-start" alignItems="center"  item xs={12} lg={12} md={12} sm={12} xl={12} className={classes.margintop8}>
                                        <AppBar position="static" color="default" className={classes.appbar}>
                                            ...
                                            >
                                                <Tab classes={{ root: classes.tabRoot, selected: classes.tabSelected }} label="SECTION 1 (Q 1-10)" component={Link} to="/listeningtest/test/listening/sec1" />
                                                <Tab classes={{ root: classes.tabRoot, selected: classes.tabSelected }} label="SECTION 2 (Q 10-20)" component={Link} to="/listeningtest/test/listening/sec2" />
                                                <Tab classes={{ root: classes.tabRoot, selected: classes.tabSelected }} label="SECTION 3 (Q 20-30)" component={Link} to="/listeningtest/test/listening/sec3" />
                                            </Tabs>
                                        </AppBar>
                                        <Switch>
                                            <Route  path={`${this.props.match.path}/sec1`} component={Sec1} />
                                            <Route path={`${this.props.match.path}/sec2`} component={Sec2} />
                                            <Route path={`${this.props.match.path}/sec3`} component={Sec3} />
                                            <Redirect to='/listeningtest/test/listening/sec1' />
                                        </Switch>
                                    </Grid>
                                </Paper>
                            </Grid>
