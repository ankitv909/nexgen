...
import './listeninginstructions.css';
...
class Listeninginstructions extends Component {
  constructor(props) {
    super(props);
    document.title = 'listeninginstructions';
    this.state = {
      checkedB: false,
    };
  }
  ...
  render() {
    ...
    return (
      <div className="listeninginstructions">
        <Grid container direction="row" justify="space-evenly" alignItems="center" item xs={12} lg={12} md={12} sm={12} xl={12} >
          <Grid container direction="row" justify="center" alignItems="center" item xs={11} lg={11} md={11} sm={11} xl={11}>
        ...
        <div >
          <Grid container direction="row" justify="center" alignItems="flex-start" item xs={12} lg={12} md={12} sm={12} xl={12} >
            <Grid container direction="row" justify="center" alignItems="center" item xs={10} lg={5} md={6} sm={7} xl={8}>
              <Paper className={classes.paper2}>
                ...
                <Grid container direction="row" justify="center" alignItems="center">
                  <Button size="large" component={Link} to="/listening" disabled={!this.state.checkedB} variant="contained" color="primary" className={classes.viewButton} >
                    Start Exam
                  </Button>
                </Grid>
              </Paper>
...
Listeninginstructions.propTypes = {
  classes: PropTypes.object.isRequired,
};


export default withStyles(styles)(Listeninginstructions);
